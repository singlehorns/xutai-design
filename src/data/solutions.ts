...
const solutions: readonly Solution[] = [
  ...
  },
  {
    ...
    description: "當企業持續需要美編、平面設計、網站維護或社群素材，部分工作也可以採固定月度或包時的外部合作模式。我會以遠端執行、固定窗口、需求排程、定期會議與工作進度整理的方式，協助安排已確認的設計及網站工作；合作範圍依實際需求討論。",
    suitableFor: ["每個月都有設計需求", "不定期需要網站更新", "常有活動／新品", "需要社群素材", "偶爾需要印刷", "偶爾需要影片", "暫時不需要增加完整全職人力"],
    scenario: ["日常文宣與社群素材持續出現，希望有固定窗口協助整理製作。", "活動與新品需求分散在不同時間，需要依優先順序安排。", "網站需要不定期更新，同時偶爾會有印刷或影片需求。", "目前需要部分持續性支援，希望先評估月度或包時的合作範圍。"],
