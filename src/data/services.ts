...
const services: readonly Service[] = [
  {
    ...
    title: "品牌與視覺設計",
    shortTitle: "品牌視覺",
    summary: "協助品牌建立或延伸一致的視覺，讓品牌、活動與日常宣傳有清楚的表達。",
    description: "從品牌想傳達的訊息與實際使用情境出發，我會整理視覺方向、資訊層級與版面，再延伸到品牌識別、主視覺及不同尺寸的宣傳素材。適合品牌建立、活動、教育招生、展覽與日常宣傳需求。",
    suitableFor: [
      "新品牌需要建立 Logo、識別與基本視覺應用。",
      "既有品牌需要統一不同媒介與尺寸的宣傳視覺。",
      "活動、研習會或教育招生需要清楚呈現主題與資訊。",
      "展覽或日常宣傳需要型錄、DM 與延伸素材。"
    ],
    deliverables: ["Logo 設計", "品牌識別", "品牌視覺延伸", "主視覺設計", "活動視覺", "研習會海報", "教育招生海報", "DM", "名片", "型錄", "社群視覺", "廣告素材", "各尺寸視覺延伸"],
